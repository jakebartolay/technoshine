  ...
  return (
    <section id="about" className="py-24 relative bg-background border-y border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="relative border border-primary/30 bg-card p-2">
              <img
                src={stonecareImageAssets.marbleHall}
          ...
          >
            ...
            <h3 className="mb-6 text-3xl font-display text-foreground md:text-5xl">
              RESTORING <br />
              <span className="text-primary">TIMELESS</span> STONE
            </h3>

            <div className="space-y-6 text-base font-light text-muted-foreground sm:text-lg">
              <p>
            ...
            <div ref={statsRef} className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2">
              <StatCounter
                target={30}
                suffix="+"
        ...
        {/* Mission & Vision */}
        <div className="mt-20 grid grid-cols-1 gap-6 md:grid-cols-[0.85fr_1.15fr]">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="relative group overflow-hidden border border-border bg-card p-6 transition-colors duration-300 hover:border-primary sm:p-8"
          >
            {/* Corner accent */}
