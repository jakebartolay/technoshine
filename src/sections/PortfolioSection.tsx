...
const projects: Project[] = [
  {
    ...
    category: "StoneCare",
    year: "2024",
    img: "images/projects/nustar.jpg",
    description: "Full marble floor restoration for a nustar resort & casino. The surfaces were polished, resealed, and protected for long-term durability.",
  ...
  },
  {
    ...
    category: "StoneCare",
    year: "2024",
    img: "images/projects/molito.jpg",
    description: "Large-scale commercial tile sealing project for a major retail complex at Molito Lifestyle Center. Covered over 3,000 sqm of high-traffic flooring.",
    highlights: ["3,000 sqm Coverage", "Anti-Slip Treatment", "Commercial Grade Sealant", "Weekend Completion"],
  },
  {
    title: "Installing Roller Barrier — Davao De Oro",
    category: "Trading",
    year: "2023",
    img: "images/projects/roller.png",
    description: "Wholesale supply and installation of roller barriers for a regional distribution center in Davao De Oro. The project included site assessment, barrier installation, and quality assurance.",
    highlights: ["Installing Roller Barrier", "Supplying", "Quality Assurance"],
  },
  {
    title: "Installing and Trading Studs — Davao De Oro",
    category: "Trading",
    year: "2023",
    img: "images/projects/stud.png",
    description: "Wholesale supply operations for a regional distribution studs in Davao De Oro",
    highlights: ["Installing Studs", "Supplying", "Quality Assurance"],
  },
  {
    title: "Hospital Projects — DPWH Contract",
    category: "Construction",
    year: "2024",
    img: "images/projects/dpwh.png",
    description: "Full construction of a 12-unit hospital, DPWH. Delivered on time with complete structural, electrical, and finishing works.",
    highlights: ["12 Rooms", "Structural Build", "Electrical & Finishing", "On-Time Delivery"],
  },
  {
    title: "Business barbershop — Cubao",
    category: "Construction",
    year: "2022",
    img: "images/projects/barber.png",
    description: "Complete business barber shop in Cubao. The project covered layout design, partitioning, flooring, and MEP works.",
    highlights: ["Structural Build", "Electrical Works",'MEP works', "Interior Finishing works"],
  },
];
